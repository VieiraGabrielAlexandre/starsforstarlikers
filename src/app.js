...
class AstronomyExplorer {
    ...
    setupEventListeners() {
        ...
        const constellationChartsOption = document.getElementById('constellationChartsOption');
        if (constellationChartsOption) {
            constellationChartsOption.addEventListener('click', () => this.showConstellationScreen());
        }

        // Back to home button
        const backToHome = document.getElementById('backToHome');
        if (backToHome) {
            backToHome.addEventListener('click', () => this.showHomeScreen());
        }
    ...
    showHomeScreen() {
        ...
        if (this.constellationScreen) {
            this.constellationScreen.classList.remove('active');
        }
     ...
     */
    showConstellationScreen() {
        if (this.homeScreen) {
            this.homeScreen.classList.add('hidden');
        }
        if (this.constellationScreen) {
            this.constellationScreen.classList.add('active');
        }

        // Reset all sections
        this.hideAllSections();

        this.toast.show('Pronto para gerar mapas estelares!', 'success', 2000);
    }
